...
그리고, 그 변화를 저희는 막을 수가 없습니다.  
  
우리가 직접 만든 속성이라면, 제어할 수 있는 속성이라면 시스템에 큰 영향을 주는 변화에 대해 선택지가 있습니다.  
하지만 우리가 제어할 수 없는 속성은 우리에게 선택지가 없습니다.  
...
이유는 **실행할때마다 달라지는, 그 값을 저희가 제어할 수 없는**   
