...
2020년 12월부터 저는 다음 회사로의 이직을 고민했습니다.  
이미 만 4년이 넘는 기간 동안 우아한형제들에서 근무하면서 신규 시스템 오픈, 레거시 시스템 개편, 클라우드 마이그레이션, 데이터베이스 마이그레이션 등 여러 경험들을 쌓았고 한 회사를 졸업하기에 적절한 시기라고 생각했기 때문입니다.  
