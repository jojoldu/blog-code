...
그래도 방문자수가 늘었다는 것은 기쁜일이니 기분좋게 생각했다.  
  
글 수는 꾸준히 유지중이다.  
1 ~ 7월까지 **72**개의 글을 썼고, 8 ~ 12월까지 **42**개의 글을 썼다.  
즉, 올해는 **총 114개**의 글을 썼다.  
...
이로써 2년 넘게 일일커밋을 유지중이다.  
[outsider님](https://blog.outsider.ne.kr/1193)이나 [권남님]()이 얘기하신것처럼 일일커밋을 한다고 꼭 코딩실력이 는다고 볼수는 없다.
...
예전엔 주말에 여자친구와 조금만 돌아다녀도 체력이 방전됐었다.  
어디 그뿐이랴  
노트북 든 가방이 무거워서 어깨가 매일 아팠다.  

처음 운동한 날엔 다리에 힘이 풀려서 집에 오는데 **7번을 엎어졌다**.  
비도 오는데 아주 가관이였다.  
넘어지고 다리에 힘풀려서 못일어나니, 지나가던 분들이 도와주실려고 했다.  
쪽팔려서 뭐 줍는척하고 그냥 가시면 된다고 

가다가 도저히 버스를 못탈것 같아 [타다](https://tadatada.com/)를 불러서 타고갔다.  
