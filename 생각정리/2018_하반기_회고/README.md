...
마소콘의 계기는 마소 394호가 출간되고 세용님께 별도로 전화가 왔다.  
글쓰는 개발자라는 주제로 

> 이 발표는 이후 [유튜브](https://www.youtube.com/watch?v=ouZrwXjusBA&t=20s)에 간단하게 정리해서 공유하였습니다.
...
회사에서 4월1일까지 프로젝트가 꽉 잡혀있다.  
2개의 큰 프로젝트인데, 둘다 일정이 밀릴수가 없어서 