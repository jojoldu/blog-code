...
- 담당 팀원들이 충분히 이걸 잘할 수 있음을 증명했고
- 이후 주문/결제 기능도 이 프로젝트에서 구현될 확률이 높고
...
근데 이 팀원들은 본인들이 충분히 사용해보고 사이드 프로젝트 결과물도 나에게 확인을 시켜주었다.  
...
개인적으로 질문에 대한 자동 답변 Bot 은 너무 흔한 기능이고 워낙 쉽게 도입할 수 있는 기능이라 **이런 것들을 빨리 도입하는게 회사의 경쟁력**이라고 생각하지 않는다.  
그래서 AI에 대해 외부에서 많이 이야기할때 본질에 좀 더 집중하자고 생각했다.  
  
그러다 인프톤의 결과가 굉장히 만족스러웠고 **AI 기능은 본질과 무관하게 우리도 일단은 하고 있다는 것을 어필**할 필요성을 느꼈다.  
...
제이크에게 이에 대해 요구를 했고, 하반기 내내 개선안을 전달드렸다.  
