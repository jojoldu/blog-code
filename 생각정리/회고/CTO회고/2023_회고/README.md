...
[인프랩 개발팀의 미션과 가치](https://inflab.atlassian.net/wiki/spaces/PartDev/pages/1074004064)을 작성해서 팀에 공유했다.
...
![](https://t3686375.p.clickup-attachments.com/t3686375/4f5eec5e-8273-4e58-b409-fb6ebe1ef5d2/image.png)
...
다만, 큰 회사에 가야지만 더 유의미한 경험과 성장을 할 수 있기 때문에

가능하면 초기 스타트업에는 합류하지 않는 것이 좋다의 여러 사례 중 하나로 남고 싶지 않음이다.

우리같이 작은 스타트업 초기에 합류한 사람들도 회사의 성장에 맞춰 충분히 성장할 수 있음을, 좋은 사례로 남기고 싶다.
...
(루카스는 본인은 FE 한지 5~6년 밖에 안되었다고 자꾸 10년차라고 하면 안된다고 하지만

프로 밥벌이 한건 10년이니깐 10년으로 하기로 했다.)
...
![](https://t3686375.p.clickup-attachments.com/t3686375/4df88cef-89b0-4d35-ab7e-307e2bd57819/image.png)
...
물론 그렇게 힐링캠프로 끝난 1차 미팅으로

진짜 본론은 한번 더 일정을 잡고 진행했지만 말이다....

  

![](https://t3686375.p.clickup-attachments.com/t3686375/9c304a91-30e5-4d3b-9832-260846268b20/image.png)

  

1차, 2차 미팅 이후로 정말 FE 파트의 변화가 체감되었다.

매주 수요일마다 하는 테크리뷰 시간에서 좀 더 적극적으로 발표를 하고

기술적 공유나 스터디 등도 더 활성화되었다.

각자가 더 분발해야한다에 대해서도 모두가 인지하고 있다보니 더더욱 노력하는 문화가 생긴것 같기도 하다.
...
그래서 바로 SWC의 아버지 강동윤님을 모시고 자유로운 QnA 시간을 가졌다.
...
![](https://t3686375.p.clickup-attachments.com/t3686375/0c7ba130-df5c-42a2-aef4-07a1a7741c1e/image.png)
...
[https://www.youtube.com/embed/1M2uCsfcIso?si=kCYH2RivVNbDbzkS](https://www.youtube.com/embed/1M2uCsfcIso?si=kCYH2RivVNbDbzkS)

  

우리 같은 사례는 어디서나 발생할 수 있는데,

그걸 계기 삼아 훨씬 더 멋진 조직이 된 사례는 많지 않은 것 같다.
...
회사들을 경험해보면 퇴사 사유가 보통은 이 팀외에 선택지가 없을때가 가장 많다.
...
![](https://t3686375.p.clickup-attachments.com/t3686375/0d5a54f6-7788-49ee-895e-4356c2512073/image.png)
...
그러다보니 관련해서 내/외부 적으로 여러 질문을 받는다.
...
충분히 좋은 분이라면 개발조직 전체 TO 내에서 직군의 밸런스 관계없이 일단 뽑는다.
...
우린 다른 스타트업에 비해 DevOps가 많으니

그만큼 애플리케이션 개발자분들이 더 일하기 좋은, 더 비즈니스에 집중할 수 있도록 전략을 수정하고 진행하는 중이다.

내년에 이에 대해서 좀 더 드라이브를 할 수 있을것 같다.
...
그러다보니 여러 컨퍼런스들에서 문의가 들어왔고, **2023 스프링 캠프 신청을 이번 오프라인 강의 기능을 활용**하는 것에 대한 논의가 진행되고 있었다.

  

모든 신청을 받은 뒤, 랜덤 추천이라면 상관없는데

이야기의 방향은 **선착순으로 티켓팅** 하는 것으로 진행되었다.
...
![](https://t3686375.p.clickup-attachments.com/t3686375/a541a6b8-ccc9-4857-8ce7-3a3283093a4f/image.png)
...
![](https://t3686375.p.clickup-attachments.com/t3686375/a19c44af-a4f1-4cfd-9382-43c638ac92ef/image.png)
...
일정도 급했는데, 선착순 API를 만들던 @제이크 (DEV) 가 훈련소 입소를 하게 되면서 그 바톤을 @선비 (DEV) 가 이어서 진행되는 등의 일도 있으면서 대혼돈의 시간을 보내기도 했다.

오픈 1시간 전 카톡으로 사전 알람을 보냈는데, 해당 사전 알람으로 접근한 사용자들만으로도 기존 인프런 서비스가 출렁거리는걸 보면서 급하게 서버와 DB 숫자를 늘리기도 했다.

  

결국 그렇게 준비한 스프링 캠프는 **43초만에 장애없이 안정적으로 티켓팅 마감**이 되었다.

![](https://t3686375.p.clickup-attachments.com/t3686375/be2ca487-f9a3-4aa4-8193-3b843ae38f39/image.png)

  

특히 **급한 일정에 맞춰 열악한 QA 환경을 제공할 수 밖에 없었음에도** QA를 깔끔하게 진행해주신 @옥돌 (COMM) @앨리스 (CON/COMM) @시리 (PO) 에게 너무나 감사했다.
...
개인적으로 질문에 대한 자동 답변 Bot 은 너무 흔한 기능이고 워낙 쉽게 도입할 수 있는 기능이라 이런 것들을 빨리 도입하는게 회사의 경쟁력이라고 생각하지 않는다.

그래서 AI에 대해 여러 스타트업들이 설레발을 이야기할때 본질에 좀 더 집중하자고 생각했다.

  

그러다 인프톤의 결과가 굉장히 만족스러웠고 AI 기능은 본질과 무관하게 우리도 일단은 하고 있다는 것을 어필할 필요성을 느꼈다.
...
@제이크 (DEV) 에게 이에 대해 요구를 했고, 하반기 내내 개선안을 전달드렸다.

제이크는 개인시간을 사용하면서 더 좋은 방법, 더 좋은 개선안을 가져오면서 하반기 내내 AI 봇을 개선해줬다.
...
![](https://t3686375.p.clickup-attachments.com/t3686375/018370f3-98d6-4cc0-8b3b-71bdba19a13e/image.png)

  

해당 영역의 전문가가 아니지만, 동기부여가 되어 있는 팀원 덕분에

내가 생각한 그 이상의 제품이 계속 출시 되고, 고객의 만족도도 높아지는 경험을 하게 되었다.

  

내년에는 좀 더 AI 봇을 비롯한 많은 기능들이 출시 될 수 있는데
...
팀에 정말 필요한 기능들을 정말 잘 뽑아냈고,

그걸 이틀만에 완성했다는 것에 한번 더 놀랬다.

> 이 중 선물하기를 제외한 대부분의 기능들이 실제 제품에 도입되었다.
...
매니저 역시 실무자들과 마찬가지로 항상 성장하는 것에 관심을 두고, 성장해야하는데

"나는 도대체 어떤 성장을 하는 것인가?" 에 대한 고민이였다.
...
뭔가 입에 발린 말만 하는 것은 아닐까 하는 생각과

팀 게임을 위해 팀원들을 가스라이팅 하는 것은 아닐까

지금 하고 있는 매니지먼트 역량이나 경험공유는 그간 배민에서, 줌에서 쌓은 경험치를 쏟아내기만 할 뿐 거기서 더 채우고 있지는 못하는게 아닐까 하는 등
...
아침 시간에는 항상 프로그래밍 관련한 작업들과 책을 보고,

실제 업무에서는 매니지먼트, 프로세스, 심리적 관리 등을 하다보니 둘 간의 불일치로 인해 그간 성장감을 못느꼈던 것 같다.
...
지금 내가 쓰고 있는 모자는 "팀워크, 매니지먼트 모자" 라는 것을 확실히 인지하고 배우고 적용하고 있다.
