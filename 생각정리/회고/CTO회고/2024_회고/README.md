...
백엔드 파트 내에서 가장 적극적으로 좋은 개발 문화 도입이나 방법론 등을 도입하기 위해 워크샵이나 주간 리뷰 시간 등에 직접 나서서 진행을 해주시기도 하셨다.  
...
매번 작은 노트를 들고와서 설계, 테스트, 구현에 대해서 물어보고 논의하던 하루의 모습이 생각난다.  
특히 인트와 함께 JVM + 검색엔진 프로젝트를 진행하면서 페어프로그래밍 할 때 즐거워하시던 모습이 기억에 남는다.  
    
두 분 모두 팀에서 정말 중요한 역할을 해주셨어서 그만큼 퇴사가 아쉬웠다.  
다만 아쉬운 만큼 그 분들이 다음에도 인프랩에서의 커리어가 도움이 될 수 있도록 더더욱 조직이 성장하는 것으로 감사함을 표현해야겠다는 생각이다.  
