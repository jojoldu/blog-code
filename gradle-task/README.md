...
-	[Gradle task 적응하기](#gradle-task-적응하기)
	-	[Build 후 SCP로 원격서버에 빌드파일 전송하기](#build-후-scp로-원격서버에-빌드파일-전송하기) - [프로젝트 생성](#프로젝트-생성) - [플러그인 추가](#플러그인-추가) - [SCP task 등록](#scp-task-등록) - [war 전송하기](#war-전송하기) - [파라미터로 설정하기](#파라미터로-설정하기) - [마무리](#마무리)
