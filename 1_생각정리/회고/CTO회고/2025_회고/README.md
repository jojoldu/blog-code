...
개인적인 생각으론 **누구나 다 AI와 프로그래밍을 배워야하는 시대**로 전환되고 있어서 오히려 장기적으로는 앞으로가 더 기회가 많을 것 같다고 본다.    
다만, 당장의 눈 앞의 시장 반응은 개발 교육, 성인 교육 시장의 위기로 보고 있으니 그에 대한 대응책이 필요했다.  
...
베트남의 개발자들은 한국의 대기업들의 복지, 처우가 좋기에 미국의 빅테크 다음으로 입사하기 좋은 기업들로 보고 있고 많이들 이직대상으로 보고 있었다.  
...
국내 시장이 워낙 크기가 작기에 버티컬로 1등을 했다면, 그 분야를 중심으로 확장해나가지 않으면 안된다.  
...
에렌의 여러 과제 중 하나인 자동 메세지가 런칭되었고, 이에 대해 정환님이 극찬해주셨다.  
...
4월의 높은 실적, 5월의 아기유니콘 선정 등 좋은 소식이 계속 이어졌지만, 여전히 2025년 전체의 매출에 대한 걱정은 없어지지 않았다.  
...
예전부터 선비는 조직이 앞으로 더 나아진다는 가정하에 항상 단단하게 기반을 다지는 것의 중요성을 얘기했다.  

반대로 나는 언제 어느때든 없어질 수 있는 것이 스타트업이고, 2년뒤, 3년뒤에 지금보다 더 서비스가 커질지 아예 축소될지 알 수 없기 때문에 미리 기반을 단단하게 작업하는 것에 대해서 이르다는 생각을 해왔다.  
뿐만 아니라 기반 플랫폼 전환이 얼마나 큰 작업인지 알기에 DevOps의 리소스를 거기에 몇달간 투자하는 것은 큰 모험이였다.  
...
그래서 EKS로의 전환 보다는 더 비즈니스에 필요한 역할에 에너지를 쏟기 위해 계속해서 EKS로의 전환을 반대했다.  
...
난 선비보다 EKS 전환에 대해 깊게 고민하는 사람이 아니였고, 이만큼 준비를 한 사람이 아니기에 선비 같은 판단력을 가진 사람이 이정도로 고민하고 준비했다면 그러면 밀어주는게 맞다고 생각했다.    

> 과거에도 IaC를 발전시켜나가는 과정에서 난 Terraform을 가능하면 계속 유지하자는 쪽이였고, 선비는 Pulumi로 전환하자는 파였는데, 결국 선비의 말이 맞았다.
  
선비가 열심히 준비했으니 오케이 한 것은 아니다.  
조직과 서비스에 결국 +효과가 얼마나 크냐를 기준으로 결정을 내리긴했다.  
...
EKS 전환으로 AWS 비용이 크게 개선되었다.  
EC2/로드밸런서/VPC/서브넷에서 감소되는 비용이 높아서 (12월 현재는) 1월 대비해서 거의 30%가 개선되었다.  
