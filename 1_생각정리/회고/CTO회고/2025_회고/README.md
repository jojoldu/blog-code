...
이 위기를 극복하기 위해 필요한 역량이 무엇일까 고민하고 정리했다.  
쭈와 함께 결정을 내렸다.
...
라이브와 채팅을 별도로 나눠 구현했기 때문에 라이브가 진행중이지 않아도 채팅에 참여가능하고 기록이 남았다.  
...
단순히 영업이익만 증가한 것이 아니라, 거래액과 순매출 모두가 증가했고 그걸 기반으로 영업이익 역시 +가 되었다.  
