...
좋은 학습 환경, 성장 환경에 대한 개선 보다 비즈니스 모델을 확장하는 프로젝트를 시작하게 됐다.  
...
랠릿 Cell의 PM으로 지내는 동안 우주, 라비, 하루 등의 퇴사를 경험하면서 라떼가 굉장히 단단해지셨다는게 느껴졌다.  
  
각 조직의 PM 분들을 믿고 온전히 실적과 고정비 절감에 대해서만 집중하기로 했다.
...
강의 학습 데이터를 통해 좋은 콘텐츠는 수료 이후에도 계속 반복 학습 한다는 것을 알게 됐다.  
다 보고나서 더이상 학습하지 않을때는 구독제는 단건 판매보다 수익이 좋지 못하지만, 지속적으로 계속 학습하는 상황에서는 이미 수료한 수강생의 구독료를 계속 수취할 수 있다.  
  
한 사람에게 5만원의 강의를 판매하는 것과 
그 한 사람이 재생할때마다 일정 수익이 계속해서 발생하는 것을 생각해봤다.  
