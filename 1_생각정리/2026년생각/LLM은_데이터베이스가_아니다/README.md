...
![DB vs LLM 비교](./images/01-db-vs-llm.svg)
...
설령 파인튜닝을 통해 일부 도메인 패턴을 학습시킬 수 있다 하더라도, 최신 사내 데이터를 저장하고 조회하는 수단으로 쓰는 것은 적절하지 않다.
...
"그럼 LLM에게 추천하는 것은 불가능하다는건가?", "요즘은 AI가 알아서 DB를 연동하잖아" 라고 생각할 수 있다.
...
![Function Calling 흐름](./images/02-function-calling-flow.svg)
...
둘째, 후보 생성의 한 방법으로 **VectorDB로 먼저 추리는 방식**이다.
...
![올바른 LLM 활용 구조](images/03-correct-architecture.svg)
