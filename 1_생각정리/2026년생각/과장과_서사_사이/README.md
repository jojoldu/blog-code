...
최근에 본 논문 중에 ["Seeing Your Life Story as a Hero's Journey Increases Meaning in Life"](https://doi.org/10.1037/pspa0000341)라는 제목의 연구가 있었다.
...
물론 이력서는 소설이 아니다.
채용 과정에서 중요한 것은 신뢰다.
자신이 하지 않은 일을 했다고 쓰면 안 된다.
책임의 크기를 속여서도 안 된다.
하지만 이력서가 단순한 사건 목록일 필요도 없다.
좋은 이력서는 내가 어떤 상황에서 무엇을 했고, 그 경험을 통해 무엇을 배웠는지 보여주는 문서다.
...
같은 일을 하더라도 그 일을 어떻게 바라볼지는 어느 정도 내가 선택할 수 있다.
나는 단순히 주문을 받았는가, 아니면 고객이 몰리는 현장에서 감정과 속도를 조율하는 법을 배웠는가.
나는 단순히 벽돌을 쌓았는가, 아니면 오래 남을 무언가의 일부를 만들고 있었는가.

물론 모든 일을 억지로 숭고하게 만들 필요는 없다.
때로 일은 그냥 일이고, 돈을 벌기 위한 시간이며, 빨리 끝났으면 하는 노동이다.
그 감각도 정직하다.
다만 내가 지나온 경험을 계속 "그냥 별거 아닌 일"로만 부르면, 그 안에서 실제로 얻은 감각까지 같이 사라진다.

삶의 만족도는 사건의 크기만으로 결정되지 않는다.
같은 사건을 어떤 이야기 안에 놓느냐에 따라 달라진다.
어떤 사람에게 첫 아르바이트는 단순한 시급 노동으로 남지만, 어떤 사람에게는 사회가 어떻게 움직이는지 처음 몸으로 배운 시간이 된다.

과장은 사실을 바꾸는 일이고, 서사는 사실의 의미를 바꾸는 일이다.

이력서에 필요한 태도는 어쩌면 이 둘 사이에 있다.
내가 하지 않은 일을 했다고 말하지 않는 것.
동시에 내가 한 일을 아무것도 아니었다고 지워버리지 않는 것.

삶의 의미는 대단한 사건에서만 생기지 않는다.
가끔은 내가 지나온 일을 어떤 문장으로 다시 부르느냐에서 생긴다.
