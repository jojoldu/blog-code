...
**당장 눈에 보이는 것에만 집중하는게 아니라 본인이 사용하는 라이브러리 세부 내역들을 일부러 더 찾아보고 테스트 해봤어야만 알 수 있는 것**이였기 때문이다.

![haru](./images/haru.png)

매번 작은 노트와 펜을 들고와서 설계, 테스트, 구현에 대해서 물어보고 논의하던 하루의 모습이 생각난다.  
인트와 함께 JVM + 검색엔진 프로젝트를 진행하면서 페어프로그래밍 할 때 즐거워하시던 모습이 특히 기억에 남는다.  
...
모든 Cell이 고생이 많았지만, 특히 **원래 담당하던 프로젝트가 아닌 다른 프로젝트를 맡았던 랠릿 Cell과 B2B Cell**이 초반에 고생을 많이 했다.  
  
해외 결제를 비롯해서 외부와의 협업으로 인해 작업 일정을 제어할 수 없었던 강의 Cell이 후반부에 가장 고생을 많이 했다.  
주말에도 해외결제 QA하고 오픈 전날에는 홍삼과 프레디가 밤을 새기도 했으니 말이다.  
  
프로젝트 중반부 부터 **랠릿 Cell과 UCC Cell이 항상 일정대로, 혹은 그것 보다 더 빠른 속도로 마무리해주셔서** 프로젝트 전체의 버퍼를 남겨주었다.  
어쩔 수 없는 사유로 생기는 프로젝트 지연 일정을 이들로 인해 적절한 타이밍에 해소할 수 있었다.  
  
**2021년에 진행했던 [루비콘 프로젝트](https://jojoldu.tistory.com/640)와 지금의 우리 팀은 완전히 다른 팀**이 되었다.  
...
**PM 개개인으로서 해결하기 힘든 프로젝트 병목 지점들이 많아서 이를 해소하는데에만 집중**했다.  
...
아저씨라는 영화와 미생이라는 드라마를 통해 김희원이라는 배우님을 알게 됐다.  
보는 사람으로 하여금 너무 짜증이 나고 무섭고 해서 정말 악역을 잘 하신다는 생각을 했다.  
그런데 예능에서 만난 실제 모습은 배역과는 너무 다른 순수한 분이셨다.  
그러면서 "**본인의 성향과 상관 없이 맡은 배역을 완벽히 해내는 것**에서 배우와 직장인이 크게 다르지 않구나" 라는 생각을 했다.   
  
그런면에서 [미경님의 블로그](https://minieetea.com/-ed-8c-80-ec-9e-a5-ec-9d-98--ec-9e-90-ec-a1-b4-ec-8b-ac-ec-9d-80--ec-96-b4-eb-94-94-eb-8b-a4--ec-88-a8-ea-b2-a8-eb-91-90-ea-b3-a0/)에서 본 굿닥터의 명장면을 자주 떠올린다.

![gooddoc](./images/gooddoc.png)

> 상황은 이렇다.  
> VIP 수술이 잡혔고, 이사장은 병원에서 인기가 있는 외과의사를 집어넣으려고 한다.  
> 외과과장은 어렵지 않은 수술인데다 스포트라이트도 받을 수 있으니 이 수술을 혼자 하고 싶은데, 위에서 탑다운으로 팀원을 추가시키라고 해서 자기 팀원인 의사와 공을 나눠가져야 되는 상황이다.  
> 마음은 들지 않지만, 고민이 되니 원장을 찾아가 이야기를 나눈다.  
> 억지 인사이지 않냐고. 그러자 원장이 이야기한다. (S1.EP3)
> "**자네가 누구야? 최고 외과 의사를 꿈꾸는 과장? 아니면 원장이 되고 싶은 과장?**  
> **후자라면 자존심은 어디다 숨겨두고 원장답게 행동해**"
> 중요하게 다뤄지는 환자가 아니라서 짧게 스치지만, 결론적으로 외과과장은 팀원을 VIP수술에 참여시켰고, 수술을 성공적으로 마친것으로 짧게 마무리되고 이야기는 다른 환자로 넘어간다.
> (출처: [기획자의 자존심은 어디다 숨겨두고](https://minieetea.com/-ed-8c-80-ec-9e-a5-ec-9d-98--ec-9e-90-ec-a1-b4-ec-8b-ac-ec-9d-80--ec-96-b4-eb-94-94-eb-8b-a4--ec-88-a8-ea-b2-a8-eb-91-90-ea-b3-a0/))

모든 조직 생활은 하나의 영화이며 그 안에서 **각자가 자신의 배역의 역할을 잘 소화해내야 하는 것**이라고 생각한다.  
**그 배역이 본인에게 너무 맞지 않거나 소신에 어긋난다 싶으면 시나리오를 거절하고 다른 영화 혹은 배역을 맡으러 가면 된다**.  
  
근데 이런 생각이 결국엔 "**하기 싫은걸 억지로 라도 해야한다**" 와 같은 느낌의 생각인 것 같아서 **80~90%까지 퍼포먼스를 낼 순 있어도 120%를 낼 순 없었다**.  
  
그래서 이걸 어떻게 하면 120%까지 낼 수 있게 긍정적으로 해석하면 좋을까 하다가, **항상 다음을 생각하기로 했다**.  
  
지금 있는 사람들, 지금의 조직에서 평생을 할 순 없다.  
새로운 사람들, 새로운 조직을 언젠간 만나게 될텐데, 여기서 **매번 하는 방법, 생각만 선택한다면 다음에도 또 그 방법, 그 생각밖에 못하는 사람**이 된다.  

"**지금 기분 내키는대로 뱉어내는 것이 습관이 되어서 다음에도 또 이렇게만 말할거야?**" 라는 생각을 하면 급격히 올라가던 기분이 차분해진다.  
그러면서 "**지금 어떻게 이야기해야 다음에도 유효할 나의 경험치가 될까?**" 라는 생각을 하면서 한마디 한마디 내뱉고 있다.  
  
특히 사람에 대한 선입견이 생기는 건 아닐까 라는 걱정을 하던 때도 있었다.    
그래서 **부정적인 생각이 들때마다 그런 생각 보다는 긍정적인 생각으로 전환하도록 행동 장치**를 마련해두고 싶었다.  
  
요즘은 부정적인 생각 혹은 선입견이 생기려고 할때마다 아래 [낫오버](https://comic.naver.com/webtoon/detail?titleId=826440&no=28&week=wed)의 장면들을 떠올리고 휴대폰을 꺼내 다시 본다.  

![notover1](./images/notover1.jpg)

![notover2](./images/notover2.jpg)

![notover3](./images/notover3.jpg)

![notover4](./images/notover4.jpg)

![notover5](./images/notover5.jpg)

![notover6](./images/notover6.jpg)

![notover7](./images/notover7.jpg)

![notover8](./images/notover8.jpg)

![notover9](./images/notover9.jpg)

![notover10](./images/notover10.jpg)

![notover11](./images/notover11.jpg)

![notover12](./images/notover12.jpg)

![notover13](./images/notover13.jpg)

![notover14](./images/notover14.jpg)

(출처: [낫오버 - 28화](https://comic.naver.com/webtoon/detail?titleId=826440&no=28&week=wed))   

다만, 이런 생각에 너무 빠져서 **해야할 말을 못하게 되는 상황도 항상 경계**하고 있다.  
그런면에서 요즘 읽은 폴인의 김태엽 대표님 인터뷰가 생각거리를 많이 줬다.

![folin](./images/folin.png)

([폴인 - "경쟁자 없애기 좋은 계절" 혹한기 뚫는 기업투자 고수를 만나다](https://www.folin.co/article/9715))  

"올해 리더로서 잘했나요?" 라고 물어본다면 몇점을 정확하게 줄 수는 없을 것 같다.  
다만, "좋은 리더가 되기 위한 장치를 추가했나요?" 라고 한다면 YES 라고 할 수 있다.  
  
나는 혼자 있는것을 좋아한다.    
그렇지만 조직 생활 밖에서, 1인 기업으로서 경제적 활동을 잘 할 수 있는 사람은 아니다.  
**조직 내에 있을때만 내 역량을 더 잘 발휘할 수 있으며, 요즘 유행하는 솔로 프리너는 나에겐 어울리지 않는다**.  
  
그런면에서 실무자 <-> 리더 <-> 상위 리더 에서 역할을 왔다갔다 할 수 있는 요즘 많은 것을 배우고 더 잘하고 싶다는 생각을 한다.  
  
"어떤 포지션에서 어떤 일이든 잘 해낼 수 있는 사람"  
그런 사람이 되고 싶다.  

## 4. 마무리
  
24일 글로벌 프로젝트 오픈 이후부터는 "어떻게 해야 글로벌에서 성과를 낼 수 있을까?" 대한 생각뿐이다.  
  
자려고 침대에 누으면 계속 불안한 생각을 한다.  

"회사의 런웨이가 끝나기 전까지도 글로벌이 성적을 못내면 어떡하지?"  
"이것 저것 다 시도해보는데도 해외에서 아무도 결제를 안해주면 어떡하지?"
"국내 매출이 여기서 더 성장하지 못하면 어떡하지?"  

그런 생각이 들면 침대에서 몇번을 뒤척이다 어렵게 잠이 들었다.  
  
이런 불안함이 들던 중, 내 안의 고약한 악마가 "**다른 곳도 나만큼 불안하지 않을까**?" 라고 귓속말을 해줬다.   
그러니깐 이상하게 마음이 편해지더라.  
  
"너도 아프잖아? 불안하잖아?"  
"그러니깐 나는 불안하지 않은 척, 아프지 않은 척, 담담한 척 할래"  
  
흔히들 남과 비교하면 안되고, 나의 어제와 비교해야한다고 한다.  
하지만 상대와의 경쟁을 하고 있는 와중에 상대를 너무 올려치기 하거나 크게 바라보면 불안함을 증폭시킨다.  
**나만 힘든게 아니라, 상대도 힘들거라고 생각하니 지금 보다 좀 더 해보자**는 생각이 확 들었다.  

"나도 이만큼 힘든데, 쟤는 얼마나 힘들겠어"  
"쟤도 힘들테니깐 지금 한발자국이라도 더 나아가야지"  
"조금만 더 해봐야지"    

내년엔 올해보다 더 잘해보자.  

(올해 가장 많이 들은 검정치마 - EVERYTHING로 마무리 한다)

<iframe width="560" height="315" src="https://www.youtube.com/embed/HXV5aZaBLDo?si=2Jp4u45W0hJx4Hqz" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
